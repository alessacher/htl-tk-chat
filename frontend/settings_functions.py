...
@Slot()
def quickConnect(mainui, settingsui):
    global connected
    if mainui.ConnectButton.text() == "Connect" and not connected:
        settingsui.ButtonStartConnection.pressed.emit()
        mainui.ConnectButton.setText("Disconnect")
    elif mainui.ConnectButton.text() == "Disconnect" and connected:
        settingsui.ButtonEndConnection.pressed.emit()
        mainui.ConnectButton.setText("Connect")
    else:
        if connected:
            mainui.ConnectButton.setText("Disconnect")
        else:
